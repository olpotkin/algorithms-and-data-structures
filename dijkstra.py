...
class Node(object):
    ...
    # Comparator
    # According to what we need define the order in the Heap?
    # Ordering according to the minimum distance (Node.minDistance)
...
class Algotirhm(object):
    ...
    def getShortestPathTo(self, targetVertex):
        print("Shortest part to the vertex is {0}".format(targetVertex.minDistance))
        node = targetVertex
